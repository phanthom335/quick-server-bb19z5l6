    """
    Quick Server Bb19z5l6
    =====================
    A fast CLI utility to deduplicate files and directories straight from the terminal.
    ...
    APP_NAME    = "Quick Server Bb19z5l6"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to deduplicate files and directories straight from the terminal.")
